sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("cus/crm/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("cus.crm.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["cus/crm/localService/mockserver"], function (mockserver) {
