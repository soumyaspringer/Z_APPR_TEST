sap.ui.define([
		...
		return BaseObject.extend("cus.crm.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias cus.crm.model.ListSelector
			 */
			 ...
			 * @return {cus.crm.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
